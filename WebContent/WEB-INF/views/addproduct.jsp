...
<script>
	function validateForm() {
		...
		if (!isNaN(x)) {
			alert("Product Name should not be a number");
			return false;
		}
		...
		if (!isNaN(x)) {
			alert("Product Category should not be a number");
			return false;
		}
	}
</script>
...
<body>
    <form:form name="addProduct" action="./AddProductServlet" method="post" onsubmit="return validateForm()" style="text-align: center;">
	  <table border="1">
